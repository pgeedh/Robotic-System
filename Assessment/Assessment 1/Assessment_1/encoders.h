...
ISR( INT6_vect ) {
  ...
  // THIS CAN BE MADE NEAT WHEN IT IS WORKING!!

  if ( state_er == 1 ) {
    count_er = count_er - 1;  // backwards

  } else if ( state_er == 2 ) {
    count_er = count_er + 1;  // forwards
...
//class Encoders_c { // Need help with this
//  public:
//
//    Encoders_c () {
//    }
